                            ...
                            <Row>
                                <Col xl={5}>
                                    ...
                                    <Stack direction={'horizontal'} gap={2} className={`mb-1 flex-wrap`}>
                                        <p className={'my-1 mx-0 fw-350 reservation-finalize-view-text'}>{bookingDetails.phone_number}</p>
                                        |
                                        <p className={'my-1 mx-0 fw-350 reservation-finalize-view-text'}>{bookingDetails.email}</p>
                                    </Stack>
                                </Col>
                                <Col xs={12} xl={7}>
